...
<dialog open bind:this={modalElement} class="absolute max-h-[28rem] w-full max-w-2xl">
	<div
		class="flex flex-1 flex-col gap-0.5 rounded-sm border border-purple-950 bg-cyan-200 p-1 shadow-[3px_4px_3px_0px_#42006e]"
	>
